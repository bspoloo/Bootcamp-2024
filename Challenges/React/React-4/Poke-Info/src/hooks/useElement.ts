...
function useElement(type: string): { imageElement: string } {
    ...
    useEffect(() => {
        ...
        setImageElement(elementImage);
    }, [type]); // Asegúrate de que este efecto se ejecute cada vez que cambie el tipo
